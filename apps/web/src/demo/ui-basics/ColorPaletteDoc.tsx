...
<ColorPalette theme="dark" />`} />
      ...
      <div className="docs-showcase-card h-auto p-4 block">
        <ColorPalette groups={[]} showUsageExamples={true} showGradients={false} />
      </div>

      <CodeBlock code={`/* Customizing color groups */
const myGroups = [
  {
    name: "Brand Colors",
    colors: [
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td><span className="docs-prop-type">'light' | 'dark' | 'all'</span></td>
              <td>'all'</td>
            ...
            <tr>
              ...
              <td><span className="docs-prop-type">ColorGroup[]</span></td>
              <td>-</td>
