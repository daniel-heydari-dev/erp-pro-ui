  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        Area charts are useful when you want trend readability from a line chart while also
        emphasizing volume over time.
      </p>

      <h2 className="docs-category-subtitle">Revenue vs Expenses</h2>
      <p className="docs-paragraph mb-4">
        A two-series area chart works well for executive summaries where users need to compare
        upside and operational spend at the same time.
      </p>

      <div className="docs-showcase-card">
        <div className="w-full max-w-5xl">
          <AreaChart data={financeData} categories={financeCategories} height={360} className="px-2" />
        </div>
      </div>
...
<AreaChart data={data} categories={categories} height={360} />`} />
      ...
      <p className="docs-paragraph mb-4">
        Add more categories when the user needs to compare related operational flows in the same
        visual frame.
      </p>

      <div className="docs-showcase-card">
        <div className="w-full max-w-5xl">
          <AreaChart data={demandData} categories={demandCategories} height={360} className="px-2" />
        </div>
      </div>
...
/>`} />
      ...
      <p className="docs-paragraph mb-4">
        Hide the grid for denser dashboards or branded analytics screens where the background needs
        to stay visually quieter.
      </p>
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>-</td>
              <td>Determines which data keys are rendered and what color each series uses</td>
            </tr>
            <tr>
