  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        ...
        and settings pages. It supports validation states, helper messaging,
        and optional right-side icons.
      </p>
      ...
      <div className="docs-showcase-grid">
        <div className="docs-showcase-card">
          <Input
            ...
            error={emailLooksInvalid ? 'Use a valid company email address.' : undefined}
          />
        </div>
        <div className="docs-showcase-card">
          <Input
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Visual state selector: <code>DEFAULT</code>,
                <code>ERROR</code>, <code>SUCCESS</code>, or
                <code>DISABLED</code>.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>-</td>
              <td>Helper text shown when <code>error</code> and <code>message</code> are empty.</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>-</td>
              <td>Supports native props such as <code>value</code>, <code>onChange</code>, <code>type</code>, <code>name</code>, and <code>disabled</code>.</td>
            </tr>
          </tbody>
        </table>
      </div>
