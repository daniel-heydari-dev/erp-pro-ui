  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        Pie and donut charts are useful for distribution summaries where the user needs share of
        total rather than time-based comparison.
      </p>

      <h2 className="docs-category-subtitle">Donut Distribution</h2>
      <p className="docs-paragraph mb-4">
        The donut style is often easier to place inside dashboards because it feels lighter and
        leaves more room for surrounding context.
      </p>

      <div className="docs-showcase-card">
        <div className="w-full max-w-4xl">
          <PieChart data={productMixData} colors={palette} variant="donut" height={320} />
        </div>
      </div>
...
/>`} />
      ...
      <p className="docs-paragraph mb-4">
        Use the solid pie when the chart is small and the visual separation between slices needs to
        stay strong.
      </p>

      <div className="docs-showcase-card">
        <div className="w-full max-w-4xl">
          <PieChart data={resolutionData} colors={compactPalette} variant="pie" height={320} />
        </div>
      </div>
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>-</td>
              <td>Array of items containing a display name and numeric value</td>
            </tr>
            <tr>
              <td className="docs-prop-name">colors</td>
              <td><span className="docs-prop-type">string[]</span></td>
              <td>-</td>
              <td>Color palette used for slices in the order they are rendered</td>
            </tr>
            <tr>
