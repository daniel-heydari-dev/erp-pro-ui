  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        MultiSelectCombobox combines search and multi-tag selection in a compact control for filters,
        permissions, team assignment, and catalog tagging.
      </p>
...
/>`} />
      ...
      <p className="docs-paragraph mb-4">
        In table headers and dashboards, use a compact background style and controlled state to keep
        multi-filter selections readable.
      </p>
      ...
      <div className="docs-showcase-card">
        <div className="w-full max-w-3xl rounded-2xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
          <div className="mb-3 flex items-center justify-between gap-3">
            <p className="text-sm font-medium text-neutral-900 dark:text-white">Task board filters</p>
            <span className="text-xs text-neutral-500 dark:text-neutral-400">{values.length} selected</span>
          </div>
      ...
      <CodeBlock code={`<MultiSelectCombobox
  options={options}
