...
export default function MyComponent() {
  return (
    <div className="flex gap-4">
      ...
      <p className="docs-paragraph">
        When adding new SVGs, place them in <code>packages/ui/src/components/icons</code>, export them in <code>index.ts</code>, and ensure they accept <code>SVGProps&lt;SVGSVGElement&gt;</code> and <code>size</code>.
      </p>
