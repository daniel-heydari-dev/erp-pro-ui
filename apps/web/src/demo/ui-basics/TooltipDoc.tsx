  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        A compact hint surface for small amounts of contextual guidance around actions and form fields.
      </p>
...
<Tooltip content="This is a helpful tip!">
  ...
  <Button label="Click Me" />
      ...
      <p className="docs-paragraph">
        Tooltips work well next to dense configuration labels when you need short explanatory copy without cluttering the form.
      </p>

      <div className="docs-showcase-card">
        <div className="w-full max-w-lg space-y-3">
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium text-neutral-900 dark:text-white">Reorder threshold</span>
  ...
  <Tooltip content="When stock drops below this number, the SKU appears in the replenishment queue.">
    <button aria-label="Threshold help">?</button>
      ...
      <p className="docs-paragraph">
        Use <span className="docs-highlight">open</span> and <span className="docs-highlight">onOpenChange</span> when the tooltip should follow external state,
        such as onboarding tours or row-by-row validation feedback.
      </p>
