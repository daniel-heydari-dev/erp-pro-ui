  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        Rich hover preview surface for profiles, metadata, and linked entities where a tooltip would be too small.
      </p>
...
>
  <span>Hover me</span>
      ...
      <p className="docs-paragraph">
        Hover cards are ideal for assignees, reviewers, or owners in tables and kanban views.
      </p>
        ...
        <HoverCard
          ...
          content={
            <div className="w-72 space-y-3">
              <div>
                <h4 className="text-sm font-bold text-neutral-900 dark:text-white">Mina Chen</h4>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div>
                  ...
                  <p className="font-semibold text-neutral-900 dark:text-white">Berlin Hub</p>
                </div>
                <div>
                  <p className="text-neutral-500 dark:text-neutral-400">Open tasks</p>
                  <p className="font-semibold text-neutral-900 dark:text-white">12</p>
                </div>
              </div>
              <p className="text-xs leading-relaxed text-neutral-500 dark:text-neutral-400">
                Owns receiving audits, transfer approvals, and supplier escalation for the central warehouse.
              </p>
            </div>
          }
        >
          <button className="docs-button docs-button-secondary">Hover Mina Chen</button>
        </HoverCard>
      </div>
...
>
  ...
  <button>Trigger</button>
      ...
      <p className="docs-paragraph">
        Tune <code>openDelay</code>, <code>closeDelay</code>, and width props for dense data tables where users move quickly.
      </p>
      <div className="docs-showcase-card h-60 flex items-center justify-center">
        <HoverCard
          ...
          content={
            <div className="space-y-2">
              <h4 className="text-sm font-semibold text-neutral-900 dark:text-white">Supplier Snapshot</h4>
        ...
        >
          <button className="docs-button docs-button-secondary">Hover Supplier #204</button>
        </HoverCard>
      </div>
