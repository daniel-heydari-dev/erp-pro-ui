import { Loading, Spinner, Dots, Pulse, Bars, Ring, Bounce, Wave } from 'erp-pro-ui';
  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        Loading covers both compact inline indicators and heavier waiting states such as overlays,
        blocking screens, and lightweight skeleton placeholders.
      </p>

      <h2 className="docs-category-subtitle">Variant Gallery</h2>
      <p className="docs-paragraph mb-4">
        The package exposes both the generic <span className="docs-highlight">Loading</span>
        component and direct indicator exports when you want to drop a specific animation into a
        tighter UI surface.
      </p>
      ...
      <div className="docs-showcase-card">
        <div className="grid w-full gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            {
              label: 'Skeleton',
              element: <Loading variant="skeleton" skeletonWidth="5rem" skeletonHeight="1rem" />,
            },
          ].map((item) => (
            <div
              key={item.label}
            ...
            >
              <div className="flex min-h-12 items-center justify-center">{item.element}</div>
              <p className="mt-4 text-sm font-medium text-neutral-700 dark:text-neutral-300">{item.label}</p>
            </div>
          ))}
        </div>
      </div>

      <CodeBlock code={`import { Loading } from 'erp-pro-ui';
...
<Loading variant="skeleton" skeletonWidth="160px" skeletonHeight="16px" />`} />
      ...
      <p className="docs-paragraph mb-4">
        Use text when the user needs confirmation about what is currently happening, especially in
        forms, bulk actions, and background sync flows.
      </p>
      ...
      <CodeBlock code={`<Loading variant="spinner" text="Saving supplier profile" />
...
/>`} />
      ...
      <p className="docs-paragraph mb-4">
        The overlay mode is useful when content already exists on screen but is temporarily locked
        while a refresh or approval step is in progress.
      </p>
        ...
        <div className="relative w-full max-w-3xl overflow-hidden rounded-2xl border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
          <div className="grid gap-3 p-6 md:grid-cols-3">
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800">
              <p className="text-sm font-medium text-neutral-900 dark:text-white">Pending approvals</p>
              <p className="mt-2 text-3xl font-semibold text-neutral-900 dark:text-white">18</p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800">
              <p className="text-sm font-medium text-neutral-900 dark:text-white">Transfers queued</p>
              <p className="mt-2 text-3xl font-semibold text-neutral-900 dark:text-white">42</p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800">
              <p className="text-sm font-medium text-neutral-900 dark:text-white">Branch sync</p>
              <p className="mt-2 text-3xl font-semibold text-neutral-900 dark:text-white">94%</p>
            </div>
          </div>
      ...
      <CodeBlock code={`<div className="relative rounded-2xl border">
  ...
  <Loading overlay variant="dots" size="lg" text="Refreshing operations queue" />
      ...
      <p className="docs-paragraph mb-4">
        For lightweight placeholders, the loading component can render an inline skeleton strip
        without switching to the dedicated skeleton component.
      </p>
      ...
      <CodeBlock code={`<Loading variant="skeleton" skeletonWidth="45%" skeletonHeight="18px" />
<Loading variant="skeleton" skeletonWidth="100%" skeletonHeight="14px" />
<Loading variant="skeleton" skeletonWidth="76%" skeletonHeight="14px" />`} />
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td><span className="docs-prop-type">'spinner' | 'dots' | 'pulse' | 'bars' | 'ring' | 'bounce' | 'wave' | 'skeleton'</span></td>
              <td>'spinner'</td>
              <td>Chooses which indicator or placeholder style is rendered</td>
            </tr>
            <tr>
              <td className="docs-prop-name">size</td>
              <td><span className="docs-prop-type">'xs' | 'sm' | 'md' | 'lg' | 'xl'</span></td>
              <td>'md'</td>
            ...
            <tr>
              ...
              <td><span className="docs-prop-type">'right' | 'bottom'</span></td>
              <td>'right'</td>
            ...
            <tr>
              ...
              <td>false</td>
              <td>Places the loader over its nearest positioned parent container</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><span className="docs-prop-type">string</span></td>
              <td>-</td>
              <td>Controls placeholder dimensions when using the skeleton variant</td>
            </tr>
            <tr>
              <td className="docs-prop-name">skeletonRounded</td>
              <td><span className="docs-prop-type">'none' | 'sm' | 'md' | 'lg' | 'full'</span></td>
              <td>'md'</td>
