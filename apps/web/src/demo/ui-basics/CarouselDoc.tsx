  ...
  const minimalCards = [
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center rounded-2xl border border-neutral-200 bg-white p-8 text-center dark:border-neutral-800 dark:bg-neutral-900">
          <div>
            <p className="text-sm uppercase tracking-[0.2em] text-neutral-500">Utilization</p>
            <p className="mt-3 text-4xl font-bold text-neutral-900 dark:text-white">94%</p>
            <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">Average picking zone occupancy</p>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center rounded-2xl border border-neutral-200 bg-white p-8 text-center dark:border-neutral-800 dark:bg-neutral-900">
          <div>
            <p className="text-sm uppercase tracking-[0.2em] text-neutral-500">Order Throughput</p>
            <p className="mt-3 text-4xl font-bold text-neutral-900 dark:text-white">1,284</p>
            <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">Orders processed in the last 24h</p>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center rounded-2xl border border-neutral-200 bg-white p-8 text-center dark:border-neutral-800 dark:bg-neutral-900">
          <div>
            <p className="text-sm uppercase tracking-[0.2em] text-neutral-500">Pending Approvals</p>
            <p className="mt-3 text-4xl font-bold text-neutral-900 dark:text-white">27</p>
            <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">Transfers awaiting release</p>
          </div>
        </div>
      ),
    },
  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        Carousel displays images or custom slides with optional autoplay, drag navigation, arrows,
        dots, and several transition styles.
      </p>
...
<Carousel items={items} animation="fade" />`} />
      ...
      <p className="docs-paragraph mb-4">
        Use custom slides for compact dashboards where each frame represents a KPI block rather
        than a full-width image.
      </p>
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>-</td>
              <td>Slides with ids and either image metadata or custom content</td>
            </tr>
            <tr>
              <td className="docs-prop-name">animation</td>
              <td><span className="docs-prop-type">'slide' | 'fade' | 'scale' | 'flip' | 'cube' | 'cards'</span></td>
              <td>'slide'</td>
