...
const ReflectiveCard = ({
  ...
  return (
    <div
      className={`relative w-[320px] h-125 rounded-[20px] overflow-hidden bg-[#1a1a1a] shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)_inset] isolate font-sans ${className}`}
