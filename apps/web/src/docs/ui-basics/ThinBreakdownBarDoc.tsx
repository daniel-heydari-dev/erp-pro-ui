  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        ThinBreakdownBar is a compact proportional indicator for showing how a
        total is divided across a small number of segments.
      </p>

      <h2 className="docs-category-subtitle">Allocation Overview</h2>
      <p className="docs-paragraph mb-4">
        Values are normalized against the total provided, so you can pass raw
        counts, percentages, or budget amounts and let the component calculate
      ...
      <CodeBlock
        code={`import { ThinBreakdownBar, BreakdownSegment } from 'erp-pro-ui';
...
export function AllocationBreakdownBarExample() {
  return <ThinBreakdownBar data={segments} />;
      ...
      <p className="docs-paragraph mb-4">
        Hide labels when the surrounding layout already provides context and the
        bar is acting as a compact status meter.
      </p>
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="docs-prop-type">BreakdownSegment[]</span>
              </td>
              <td>-</td>
              <td>
                Segments containing label, value, optional id, and display color
              </td>
            </tr>
            <tr>
              ...
              <td>true</td>
              <td>
                Controls whether the segment labels are rendered under the track
              </td>
            </tr>
            <tr>
