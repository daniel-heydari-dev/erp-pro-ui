  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        A generic hoverable frame that adds animated border emphasis to buttons,
        pills, and small CTA surfaces.
      </p>
      ...
      <CodeBlock
        code={`import { HoverBorderGradient } from 'erp-pro-ui';
...
<HoverBorderGradient className="px-8 py-3 bg-white dark:bg-black text-black dark:text-white">
  <span>Hover Me</span>
      ...
      <CodeBlock
        code={`<HoverBorderGradient duration={2} clockwise={true}>
  Slow Clockwise
</HoverBorderGradient>
...
<HoverBorderGradient duration={0.5} clockwise={false}>
  Fast Counter
      ...
      <p className="docs-paragraph">
        Wrap smaller actions when you want a subtle premium accent without
        turning the entire panel into a hero component.
      </p>
