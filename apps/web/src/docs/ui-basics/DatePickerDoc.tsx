  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        DatePicker supports single-date and range selection with optional
        presets for recurring workflows like reporting windows and booking
        periods.
      </p>
      ...
      <CodeBlock
        code={`import { DatePicker } from 'erp-pro-ui';
...
/>`}
      ...
      <p className="docs-paragraph">
        Set <code>mode="range"</code> to allow users to select a start and end
        date.
      </p>
      <div className="docs-showcase-card">
...
/>`}
      ...
      <p className="docs-paragraph">
        Define custom presets for common timeframes like "Start of Year" or
        "Next Month".
      </p>
      <div className="docs-showcase-card">
        <div className="w-full max-w-xs">
...
/>`}
      ...
      <p className="docs-paragraph mb-4">
        Use helper text for context and disabled mode when date input is
        controlled by upstream business logic.
      </p>
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="docs-prop-type">DatePickerValue</span>
              </td>
              <td>-</td>
            ...
            <tr>
              ...
              <td>'single'</td>
              <td>
                Switches between one-date selection and start/end range
                selection
              </td>
            </tr>
            <tr>
              ...
              <td>
                <span className="docs-prop-type">DatePickerPreset[]</span>
              </td>
              <td>-</td>
              <td>
                Optional quick-select shortcuts rendered under the calendar
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>false</td>
              <td>
                Disables interaction and hides the calendar popover trigger
                state
              </td>
            </tr>
          </tbody>
