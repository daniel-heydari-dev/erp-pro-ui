  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        A premium theme toggle with animated icon morphing that works inside the
        global ThemeProvider used by the web app.
      </p>

      {/* Basic Usage */}
      <h2 className="docs-category-subtitle">Interactive Toggle</h2>
      <p className="docs-paragraph">
        Click the button to see the sun morph into a moon with spring-based
        animations.
      </p>
      ...
      <CodeBlock
        code={`import { SunToMoonButton } from 'erp-pro-ui';
...
<SunToMoonButton showLabelAndImage={false} />`}
      ...
      <p className="docs-paragraph">
        The compact variant fits naturally into workspace headers and utility
        bars.
      </p>
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>true</td>
              <td>
                Whether to display the "Light/Dark" label and the UI mockup
                below the icon
              </td>
            </tr>
          </tbody>
