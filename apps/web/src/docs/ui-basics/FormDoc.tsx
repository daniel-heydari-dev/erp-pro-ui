  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        Form is a styled wrapper for grouped inputs and submission controls. It
        behaves like a standard HTML form and works with native submit handling
        patterns.
      </p>
  ...
  return (
    <Form title="Sign in" onSubmit={handleSubmit} className="space-y-4">
      ...
      <p className="docs-paragraph mb-4">
        Use the built-in title and description for section framing, then group
        inputs by intent so users can scan settings quickly.
      </p>
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>-</td>
              <td>
                Native submit handler. Use FormData to extract values from named
                fields.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>-</td>
              <td>
                Inputs, controls, and action buttons rendered inside the form
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>'lg'</td>
              <td>
                Vertical spacing preset used between top-level form sections
              </td>
            </tr>
          </tbody>
        </table>
