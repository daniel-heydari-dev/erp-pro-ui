...
const CardDoc = () => {
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        A compact summary surface for highlights, empty states, and lightweight
        dashboard content.
      </p>
  ...
  <Card title="Warehouse Health" description="Cycle-count completion is currently at 96% across all active zones." />
      ...
      <p className="docs-paragraph">
        The component still reads cleanly when the description needs more
        operational detail.
      </p>
...
/>`}
      ...
      <p className="docs-paragraph">
        ...
        <span className="docs-highlight"> description </span>, then compose
        layout around the card with your own containers.
      </p>
