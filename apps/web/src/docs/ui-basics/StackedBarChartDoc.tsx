  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        Stacked bars help users compare total volume while still seeing how that
        total is composed by category.
      </p>

      <h2 className="docs-category-subtitle">Daily Team Mix</h2>
      <p className="docs-paragraph mb-4">
        This pattern is useful for workload planning, staffing distribution, or
        any dashboard where multiple contributors add up to a shared total.
      </p>
  ...
  return (
    ...
    />
      ...
      <h2 className="docs-category-subtitle">
        Consistent Scale Across Reports
      </h2>
      <p className="docs-paragraph mb-4">
        Set a fixed Y-axis domain when adjacent charts need to remain visually
        comparable instead of auto-scaling independently.
      </p>
...
export function AutoDomainStackedBarChartExample() {
  return <StackedBarChart data={staffingData} categories={staffingCategories} />;
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="docs-prop-type">StackedBarData[]</span>
              </td>
              <td>-</td>
              <td>
                Array of items containing one shared name field plus multiple
                numeric series
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <span className="docs-prop-type">[number, number]</span>
              </td>
              <td>auto</td>
              <td>
                Optional fixed vertical scale for consistent cross-chart
                comparison
              </td>
            </tr>
            <tr>
      ...
      <DocsButtonBar
        ...
        next={{
          label: "Thin Breakdown Bar",
          route: "/ui-basics/thin-breakdown-bar",
        }}
      />
    </section>
  );
