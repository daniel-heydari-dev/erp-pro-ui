...
const ChromaGridDoc = () => {
  const items = [
    { id: "1", title: "Design", description: "Clean & Modern UI", icon: "🎨" },
    {
      id: "2",
      title: "Performance",
      description: "Blazing Fast Speed",
      icon: "⚡",
    },
    {
      id: "3",
  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        A visually striking grid component with staggered animations and
        ...
        <table className="docs-props-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="docs-prop-type">ChromaGridItem[]</span>
              </td>
              <td>-</td>
