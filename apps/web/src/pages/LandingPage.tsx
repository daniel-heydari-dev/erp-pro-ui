...
const stackedBarData = [
  { name: '1/31', Construction: 700, Business: 600, Leisure: 400, Manufacturing: 600, Wholesale: 300 },
  { name: '2/1', Construction: 600, Business: 750, Leisure: 500, Manufacturing: 300, Wholesale: 200 },
  { name: '2/2', Construction: 900, Business: 800, Leisure: 600, Manufacturing: 400, Wholesale: 500 },
  { name: '2/3', Construction: 1000, Business: 900, Leisure: 700, Manufacturing: 500, Wholesale: 400 },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24 md:pt-24">
        ...
        <header className="flex flex-col items-center text-center space-y-8 mb-32">
          <AnimatedContent preset="slideUp" duration={0.8}>
            <div className="w-full max-w-5xl h-[200px] md:h-[400px] relative">
              <ASCIIText
                text="erp-pro-ui"
                asciiFontSize={10}
                textFontSize={300}
          ...
          <AnimatedContent preset="fade" delay={0.4} duration={0.8} className="space-y-6">
            <p className="text-xl md:text-2xl text-zinc-300 font-medium">
              The Premier React Component Library for <br className="hidden md:block" />
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-32">
          {/* Card 1: Inventory */}
          <SpotlightCard variant="glass" className="group h-[320px]">
            <div className="flex flex-col h-full justify-between">
              <div className="p-2">
                <h3 className="text-lg font-semibold mb-1">Inventory Overview</h3>
          ...
          <SpotlightCard variant="glass" className="group h-[320px]">
            <div className="flex flex-col h-full justify-between">
              <div className="p-2">
                <h3 className="text-lg font-semibold mb-1">Supplier Management</h3>
        ...
        <footer className="pt-24 pb-12 grid md:grid-cols-4 gap-12 border-t border-zinc-900">
          <div className="col-span-2 space-y-6">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center font-bold text-xs">ERP</div>
              <span className="font-semibold text-lg tracking-tight">erp-pro-ui</span>
            </div>
            <p className="text-sm text-zinc-500 max-w-xs leading-relaxed">
              Design systems and premium components optimized for industrial-grade store management and ERP software.
            </p>
          </div>
